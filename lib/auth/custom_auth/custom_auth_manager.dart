...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    vigilantAuthUserSubject.add(
      VigilantAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<VigilantAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  VigilantAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = VigilantAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    vigilantAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
